...
//     document.getElementById('text').hidden = true // кнопка створена у html документі
// }

//     - створити інпут який приймає вік людини та кнопку яка підтверджує дію.При натисканні на кнопку зчитати інформацію з інпуту та перевірити вік чи меньше він ніж 18, та повідомити про це користувача

// let arr = []
// let form1 = document.forms.first
//
...
//     arr.push(age)
//     if (arr[0] <= 18) {
//         alert('Ви ще неповнолітні. Перезавантажте сторінку і спробуйте ввести коректгі дані')
//     } else {
